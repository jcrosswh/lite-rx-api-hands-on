 ...
 * @see
 * <a href="http://projectreactor.io/core/docs/api/reactor/core/publisher/Flux.html">Flux
 * Javadoc</a>
 */
...
//========================================================================================
    ...
    Flux<Long> counter() {
        return Flux.just(0L, 1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L).delay(Duration.ofMillis(100L));
    }
